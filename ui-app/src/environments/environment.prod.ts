...
export const environment = {
  ...
  dcf_fence_login_url: 'https://nci-crdc-staging.datacommons.io/user/oauth2/authorize?client_id=H6iXY25cRF7Ew5JkH3GJiY6mja2wy1cUncRutnQQ&response_type=code&redirect_uri=https%3A%2F%2Fpdc.esacinc.com%2Fpdc%2Ffence&scope=openid+data+user',
