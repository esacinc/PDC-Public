...
@Component({
    ...
    styleUrls: ['../../../assets/css/global.css', './browse-by-case.component.scss', '../browse-table.component.css'],
  ...
  ngOnChanges(changes: SimpleChanges){
	...
	downloadCompleteManifest(buttonClick = false) {
		setTimeout(() => {
			...
			this.browseByCaseService.getFilteredCasesPaginated(0, 0, this.sort, this.newFilterSelected, true).subscribe((data: any) =>{
